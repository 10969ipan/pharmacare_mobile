      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Silakan pilih obat kebutuhan Anda di halaman Beranda.',
                      ...
                      Row(
                        children: [
                          _buildQuantityButton(
                            icon: Icons.remove,
                            onPressed: () => cartProvider.decrementQuantity(item.judul),
                          ),
                          Padding(
                          ...
                          _buildQuantityButton(
                            icon: Icons.add,
                            onPressed: () => cartProvider.incrementQuantity(item.judul),
                          ),
                        ],
                      ),
                    ],
          ...
          children: [
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  cartProvider.totalPriceFormatted,
                  style: TextStyle(
                    fontSize: 20,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Terima kasih! Pesanan obat Anda telah diterima dan sedang diproses.'),
          actions: [
            TextButton(
              onPressed: () {
