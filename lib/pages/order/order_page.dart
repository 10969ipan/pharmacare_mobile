      ...
      child: Scaffold(
        ...
        body: Consumer<CartProvider>(
          builder: (context, cartProvider, child) {
            final activeOrders = cartProvider.orders
                .where((order) => order['isCompleted'] == false)
                .toList();
            final completedOrders = cartProvider.orders
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (order['color'] as Color).withValues(alpha: 0.15),
                ...
                Text(
                  order['tanggal'] as String,
                  style: TextStyle(color: Colors.grey[600], fontSize: 13),
                ),
                const SizedBox(height: 8),
                Text(
                  order['obat'] as String,
